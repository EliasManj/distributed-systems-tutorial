...
public class WebServer {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(String.format("Server is listening on port %d", serverPort));
    }
    ...
    private void handleTaskRequest(HttpExchange exchange) throws IOException {
        ...
        if (headers.containsKey("X-Dedbug") && headers.get("X-Debug").get(0).equalsIgnoreCase("true")) {
            isDebugMode = true;
        }
        long startTime = System.nanoTime();
        byte[] requestBytes = readFully(exchange.getRequestBody());
